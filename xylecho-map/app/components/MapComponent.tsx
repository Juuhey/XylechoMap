...
const MapComponent = () => {
  ...
  useEffect(() => {
    setIsMounted(true); // Active le rendu après que le composant soit monté côté client
  }, []);
  ...
  }, []); // Le tableau vide garantit que l'effet ne s'exécute qu'une seule fois après le rendu du composant
